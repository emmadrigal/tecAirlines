...
namespace TecAirlines
{
    ...
    /// <summary>
    /// Class with general methods to manage XML files
    /// </summary>
    abstract public class DatabaseAccess
    {
        ...
        /// <summary>
        /// The contructor uses a DatabaseAccessBuilder
        /// </summary>
        ...
        /// <summary>
        /// This method gets all the elements from the file
        /// </summary>
        /// <returns></returns>
        protected List<XElement> GetAllElements()
        {
